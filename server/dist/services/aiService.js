...
exports.analyzeExpiryRisk = exports.predictDemand = void 0;
const predictDemand = async (medicineId) => {
...
const analyzeExpiryRisk = async (hospitalId) => {
    // Simulate ML model latency
...
exports.analyzeExpiryRisk = analyzeExpiryRisk;
